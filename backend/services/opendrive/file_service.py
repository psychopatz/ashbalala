...
from backend.models.opendrive.file_models import (
    CreateFileResponse, OpenFileUploadResponse,
    UploadFileChunkResponse, CloseFileUploadResponse
)
...
class FileService(IFileService):
    ...
    async def check_file_exists(self, folder_id: str, session_id: str, names: list) -> dict:
